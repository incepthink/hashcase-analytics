...
export default function GrowthChart({ chartDatasets }: GrowthChartProps) {
  ...
  useEffect(() => {
    ...
    console.log("Initializing growth chart with dimensions:", rect);
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("Error updating growth chart:", err);
    }
  }, [chartDatasets]);
